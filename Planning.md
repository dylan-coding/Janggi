...
Features 		To Do
General 	- General can perform valid moves 	
			- General cannot perform invalid moves 	
		
Guard 		- Advisor can perform valid moves 	
			- Advisor cannot perform invalid moves 	
	
Horse 		- Horse can perform valid moves 	
			- Horse cannot perform invalid moves 	
		
Soldier 	- Soldiers cannot perform invalid moves 	
			- Soldiers can perform valid moves 	
		
Elephant 	- Elephant can perform valid movies 	
			- Elephant cannot perform valid moves 	
		
Chariot 	- Chariot can perform valid moves 	
			- Chariot cannot perform invalid moves 	
		
Cannon 		- Cannon cannot perform valid moves 	
			- Cannon can perform valid moves 	
		
is_in_check - Check is detected correctly for each player 	
		
make_move 	- Can pass turns 	
		
		
get_game_state 	- returns UNFINISHED correctly 	
				- returns BLUE_WON correctly 	
				- returns RED_WON correctly 	

Other Factors:
	- Handles valid algebraic notations correctly
	- Captured piece is replaced with the capturing piece
	- Check forces a move to be made by the player to counter the check
	- Red is not able to start
	- Starting board positions initialized correctly
	- Turn taking works correctly
	- Player is not able to move after checkmate