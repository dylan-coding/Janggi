...
class TestJanggiGame(unittest.TestCase):
    ...
    def test_passing_the_turn_after_being_captured(self):
        ...
        self.assertIs(passing_move, True)
        valid_move_after_passing = g.make_move('a4',
                                               'a3')  # valid move by Blue
        self.assertIs(valid_move_after_passing, True)
    ...
    def test_valid_forward_move_for_blue_soldier(self):
        ...
        g = JanggiGame()
        blue_soldier_forward_move = g.make_move('c7',
                                                'c6')  # because blue moves first
    ...
    def test_valid_sideway_move_for_blue_soldier(self):
        ...
        g = JanggiGame()
        blue_soldier_sideway_move = g.make_move('c7',
                                                'b7')  # because blue moves first
    ...
    def test_invalid_backward_move_for_blue_soldier(self):
        ...
        g = JanggiGame()
        blue_soldier_backward_move = g.make_move('c7',
                                                 'c8')  # try backward move which is illegal
    ...
    def test_invalid_diagonal_move_for_blue_soldier(self):
        ...
        g = JanggiGame()
        blue_soldier_diagonal_move = g.make_move('c7',
                                                 'd6')  # try diagonal which is illegal
    ...
    def test_invalid_backward_move_for_red_soldier(self):
        ...
        red_soldier_backward_move = g.make_move('c4',
                                                'c3')  # try backward move which is illegal
    ...
    def test_invalid_diagonal_move_for_red_soldier(self):
        ...
        g.make_move('c7', 'c6')  # because blue moves first
        red_soldier_backward_move = g.make_move('c4',
                                                'd5')  # try diagonal move which is illegal
        self.assertIs(red_soldier_backward_move, False)
    ...
    def test_that_a_captured_piece_cannot_be_moved(self):
        ...
        g.make_move('i5', 'i6')  # valid move by Red
        capturing_move = g.make_move('a5', 'a4')  # capturing move by Blue
        move_on_a_non_existent_piece = g.make_move('a4',
                                                   'a5')  # move from a location owned by Red
    ...
    def test_valid_sideway_move_for_red_chariot(self):
        ...
        red_chariot_sideway_move = g.make_move('a2',
                                               'c2')  # chariot moves sideway
    ...
    def test_valid_forward_move_for_blue_chariot(self):
        ...
        g = JanggiGame()
        blue_chariot_forward_move = g.make_move('a10',
                                                'a8')  # because blue moves first
    ...
    def test_valid_backward_move_for_blue_chariot_in_south(self):
        ...
        g.make_move('a1', 'a2')  # move the red chariot ahead
        blue_chariot_backward_move = g.make_move('a8',
                                                 'a9')  # chariot moves backward
    ...
    def test_invalid_diagonal_move_for_blue_chariot_in_northeast(self):
        ...
        invalid_chariot_diagonal_move = g.make_move('a8',
                                                    'b7')  # blue chariot moves east
    ...
    def test_invalid_diagonal_move_for_red_chariot_to_southeast(self):
        ...
        invalid_chariot_diagonal_move = g.make_move('a3',
                                                    'b4')  # red chariot moves southeast
        self.assertIs(invalid_chariot_diagonal_move, False)
        pass
    ...
    def test_valid_north_move_for_blue_cannon(self):
        ...
        cannon_valid_move = g.make_move('b8',
                                        'b4')  # blue cannon jumps over blue soldier
    ...
    def test_valid_east_move_for_blue_cannon(self):
        ...
        cannon_valid_move = g.make_move('b6',
                                        'e6')  # blue cannon jumps over blue soldier east two steps
        self.assertIs(cannon_valid_move, True)
    ...
    def test_valid_west_move_for_blue_cannon(self):
        ...
        cannon_valid_west_move = g.make_move('h5',
                                             'a5')  # blue cannon jumps west
        self.assertIs(cannon_valid_west_move, True)

        # now try moving that cannon again back to make sure it was actually placed there
        g.make_move('g5', 'g5')  # red passes
        valid_cannon_move_back = g.make_move('a5',
                                             'h5')  # blue cannon moves east
    ...
    def test_valid_south_move_for_blue_cannon(self):
        ...
        g.make_move('g5', 'g5')  # red passes
        valid_cannon_move_south = g.make_move('a5',
                                              'a9')  # blue cannon moves south
        self.assertIs(valid_cannon_move_south, True)
        # now try moving that cannon again back to make sure it was actually placed there
        g.make_move('g5', 'g5')  # red passes
        valid_cannon_move_back = g.make_move('a9',
                                             'a6')  # blue cannon moves north
        self.assertIs(valid_cannon_move_back, True)
    ...
    def test_invalid_diagonal_move_for_blue_cannon_with_a_screen(self):
        ...
        g = JanggiGame()
        cannon_invalid_move = g.make_move('b8',
                                          'd6')  # blue cannon jumps northwest
    ...
    def test_invalid_forward_move_for_blue_cannon_without_a_screen(self):
        ...
        g = JanggiGame()
        cannon_invalid_move = g.make_move('b8',
                                          'b7')  # blue cannon move forward without a screen
        self.assertIs(cannon_invalid_move, False)

    #    @visibility('after_due_date')
    def test_invalid_forward_move_for_blue_cannon_capturing_another_cannon(
            self):
        ...
        invalid_cannon_move = g.make_move('b6',
                                          'b3')  # cannon jumps over red soldier to capture red cannon
        self.assertIs(invalid_cannon_move, False)

    #    @visibility('after_due_date')
    def test_invalid_forward_move_for_blue_cannon_jumping_over_red_cannon(
            self):
        ...
        invalid_cannon_move = g.make_move('b6',
                                          'b2')  # blue cannon jumps over red cannon
        self.assertIs(invalid_cannon_move, False)
    ...
    def test_valid_forward_move_for_blue_cannon_capturing_red_soldier(self):
        ...
        capturing_move = g.make_move('b8',
                                     'b5')  # blue cannon jumps north to capture red soldier
    ...
    def test_horse_is_blocked_by_a_piece(self):
        ...
        try:
            invalid_move_because_of_block = g.make_move('d8',
                                                        'c6')  # invalid move because blocked by own soldier
            self.assertIs(invalid_move_because_of_block, False)
        except:
            self.fail(
                "Blue horse from west should not be able to jump over a blue piece")
        g.make_move('d8', 'd8')  # blue passes the turn

        try:
            invalid_move_because_of_block = g.make_move('d3',
                                                        'd6')  # invalid move by red because blocked by own soldier
            self.assertIs(invalid_move_because_of_block, False)
        except:
            self.fail(
                "Red horse from west should not be able to jump over a red piece")
        ...
        try:
            ...
            self.fail(
                "Blue horse from east should not be able to jump over a blue piece")

        g.make_move('g8', 'g8')  # blue passes the turn

        try:
            invalid_move_because_of_block = g.make_move('g3',
                                                        'g5')  # invalid move because blocked by own soldier
            self.assertIs(invalid_move_because_of_block, False)
        except:
            self.fail(
                "Red horse from east should not be able to jump over a red piece")
    ...
    def test_horse_can_capture_a_piece(self):
        ...
        try:
            ...
            self.fail(
                "Blue Horse from West should be able to capture a Red soldier")
        ...
        try:
            ...
            self.fail(
                "Red Horse from West should be able to capture a Blue Soldier")
        ...
        try:
            ...
            self.fail(
                "Red Horse from East should be able to capture a Blue Soldier")
        ...
        try:
            ...
            self.fail(
                "Blue Horse from East should be able to capture a Red soldier")
    ...
    def test_horse_cannot_capture_own_piece(self):
        ...
        g = JanggiGame()
        try:
            invalid_capturing_move = g.make_move('c10',
                                                 'b8')  # blue horse tries to get at the same place as Cannon
            self.assertIs(invalid_capturing_move, False)
        except:
            self.fail(
                "Blue Horse from west should not be able to capture a blue piece")

        g.make_move('g7', 'g7')  # blue passing move

        try:
            invalid_capturing_move = g.make_move('c1',
                                                 'b3')  # red horse tries to get at the same place as Cannon
            self.assertIs(invalid_capturing_move, False)
        except:
            self.fail(
                "Red Horse from west should not be able to capture a red piece")

        try:
            g.make_move('h1', 'g3')  # red horse moves
            g.make_move('g7', 'g7')  # blue passes
            invalid_capturing_move = g.make_move('g3',
                                                 'f1')  # red horse tries to get at the same place as red guard
            self.assertIs(invalid_capturing_move, False)
        except:
            self.fail(
                "Red Horse from west should not be able to capture a red piece")
        ...
        try:
            ...
            invalid_capturing_move = g.make_move('g8',
                                                 'f10')  # blue horse tries to get at the same place as blue guard
            self.assertIs(invalid_capturing_move, False)
        except:
            self.fail(
                "Blue Horse from east should not be able to capture a blue piece")
    ...
    def test_valid_move_for_guard(self):
        ...
        try:
            ...
            self.fail(
                "Blue Guard from west should be able to make a valid move")
        ...
        try:
            ...
            self.fail(
                "Red Guard from west should be able to make a valid move")
        ...
        try:
            ...
            self.fail(
                "Blue Guard from east should be able to make a valid move")
        ...
        try:
            ...
            self.fail(
                "Red Guard from east should be able to make a valid move")
    ...
    def test_invalid_move_for_guard(self):
        ...
        try:
            invalid_move = g.make_move('d8',
                                       'c8')  # blue guard tries to move outside the palace
            self.assertIs(invalid_move, False)
        except:
            self.fail(
                "Blue Guard should not be able to move outside the palace")

        g.make_move('d8', 'd8')  # blue passes

        try:
            invalid_move = g.make_move('d3',
                                       'c3')  # red guard tries to move outside the palace
            self.assertIs(invalid_move, False)
        except:
            self.fail(
                "Red Guard should not be able to move outside the palace")

        g.make_move('d3', 'd3')  # red passes

        try:
            invalid_move = g.make_move('f8',
                                       'g8')  # blue guard tries to move outside the palace
            self.assertIs(invalid_move, False)
        except:
            self.fail(
                "Blue Guard should not be able to move outside the palace")
        ...
        try:
            invalid_move = g.make_move('f3',
                                       'g3')  # red guard tries to move outside the palace
            self.assertIs(invalid_move, False)
        except:
            self.fail(
                "Red Guard should not be able to move outside the palace")
    ...
    def test_valid_move_for_elephant(self):
        ...
        try:
            ...
            self.fail(
                "Blue Elephant from west should be able to make a valid move")
        ...
        try:
            ...
            self.fail(
                "Red Elephant from west should be able to make a valid move")

        g.make_move('e7',
                    'e6')  # blue soldier moves to make place for eastern blue elephant
        g.make_move('e4',
                    'e5')  # red  soldier moves to make place for eastern red elephant
        ...
        try:
            ...
            self.fail(
                "Blue Elephant from east should be able to make a valid move")
        ...
        try:
            ...
            self.fail(
                "Red Elephant from east should be able to make a valid move")
    ...
    def test_invalid_move_for_elephant(self):
        ...
        self.assertIs(invalid_move, False)
        invalid_move = g.make_move('g1',
                                   'g5')  # tries to jump over the soldier
        self.assertIs(invalid_move, False)
    ...
    def test_is_in_check_blue(self):
        ...
        try:
            ...
            self.fail(
                "General is not in check and yet is_in_check returns True for red")

        try:
            self.assertIs(g.is_in_check('blue'), False)
        except:
            self.fail(
                "General is not in check and yet is_in_check returns True for blue")

        g.make_move('h8', 'c8')  # blue cannon moves -- check here
        g.make_move('d3', 'e5')  # red
        g.make_move('c8',
                    'c4')  # blue cannon captures red soldier -- check here
        try:
            self.assertEqual(g.get_game_state().upper(), 'UNFINISHED')
        except:
            self.fail("Game state should be unfinished before an actual check")
        ...
        self.assertTrue(g.make_move('e6',
                                    'e3'))  # red CHECKS blue using a cannon -- special test for checks using a cannon -- check here
        ...
        try:
            ...
            self.fail(
                "Red General is not in check and yet is_in_check returns True for red")

        try:
            self.assertIs(g.is_in_check('blue'), True)
        except:
            self.fail(
                "Blue General is in check and is_in_check should return True for blue")
        ...
        try:
            ...
            self.fail(
                "Game state should be UNFINISHED when a general is in check")
    ...
    def test_is_in_check_red(self):
        ...
        g.make_move('h3',
                    'h9')  # red cannon moves to a position where it COULD Check but has not. -- check here
        g.make_move('a10', 'a7')
        ...
        g.make_move('b1', 'c1')
        g.make_move('a4',
                    'a2')  # blue CHECKS red using a chariot -- check here

        try:
            self.assertIs(g.is_in_check('red'), True)
        except:
            self.fail(
                "Red General is in check and yet is_in_check returns False for red")

        try:
            self.assertIs(g.is_in_check('blue'), False)
        except:
            self.fail(
                "Blue General is not in check and yet is_in_check returns True for blue")
        ...
        g.make_move('e2',
                    'e1')  # red general moves to avoid capture -- check after this
    ...
    def test_a_checkmate_is_detected_correctly(self):
        ...
        g.make_move('c1',
                    'c9')  # red chariot moves to the palace to CHECKMATE blue
    ...
    def test_a_move_cannot_be_made_after_checkmate(self):
        ...
        try:
            invalid_move_after_checkmate = g.make_move('c9',
                                                       'c1')  # red chariot move
            self.assertIs(invalid_move_after_checkmate, False)
            invalid_move_after_checkmate = g.make_move('i8',
                                                       'i7')  # red Elephant move
            self.assertIs(invalid_move_after_checkmate, False)
        except:
        ...
        try:
            invalid_move_after_checkmate = g.make_move('d9',
                                                       'e9')  # blue General move
            self.assertIs(invalid_move_after_checkmate, False)
            invalid_move_after_checkmate = g.make_move('e1',
                                                       'f2')  # red General move
            self.assertIs(invalid_move_after_checkmate, False)
        except:
            self.fail("make_move should not allow any move after a checkmate")
    ...
    def test_turn_taking_is_implemented_correctly(self):
        ...
        # blue moves first
        try:
            invalid_first_move = g.make_move('a1',
                                             'a3')  # red tries to move first
    ...
    #    @visibility('after_due_date')
    def test_that_horse_is_transposed_with_elephant_in_the_initial_setup_by_trying_to_move_it(
            self):
        ...
        try:
            ...
            self.fail(
                "Blue Elephant from east is either not transposed correctly with Horse in the inital setup or cannot perform valid moves")
        ...
        try:
            ...
            self.fail(
                "Red Elephant from east is either not transposed correctly with Horse in the inital setup or cannot perform valid moves")
    ...
    def test_that_a_check_by_a_cannon_outside_the_palace_is_detected(self):
        ...
        try:
            ...
            self.fail(
                "Blue General is in check with a Cannon outside the palace and is_in_check should return True for blue")
    ...
    def test_that_a_check_by_a_horse_outside_the_palace_is_detected(self):
        ...
        try:
            ...
            self.fail(
                "Blue General is in check with a Horse outside the palace and is_in_check should return True for blue")

    #    @visibility('after_due_date')
    def test_that_countering_the_check_by_capturing_the_cannon_is_detected_correctly(
            self):
        ...
        self.assertTrue(g.make_move('b3',
                                    'e3'))  # red CHECKS blue using a cannon -- special test for checks using a cannon -- check here
        ...
        counter_check_move = g.make_move('d5',
                                         'e3')  # evade the cannon check by capturing the cannon using a horse
        ...
        try:
            ...
            self.fail(
                "Countering of the check by cannon by capturing it should be detected correctly and is_in_check should return False for blue")
    ...
    #    @visibility('after_due_date')
    def test_that_countering_the_check_by_blocking_the_cannon_is_detected_correctly(
            self):
        ...
        counter_check_move = g.make_move('f8',
                                         'e8')  # evade the cannon check by blocking the cannon using the chariot
        self.assertTrue(counter_check_move)
        ...
        try:
            ...
            self.fail(
                "Countering of the check by cannon by blocking it should be detected correctly and is_in_check should return False for blue")
    ...
    def test_that_check_forces_a_move_to_be_made_to_counter_the_check(self):
        ...
        non_counter_check_move = g.make_move('f8',
                                             'f7')  # a move that does not evade the check
        try:
            self.assertFalse(non_counter_check_move)
        except:
            self.fail(
                "Blue should be forced to make a move that evades a check when checked")

        non_counter_check_move = g.make_move('e9',
                                             'e10')  # general moves not countering the check
        try:
            self.assertFalse(non_counter_check_move)
        except:
            self.fail(
        ...
        non_counter_check_move = g.make_move('f6',
                                             'f5')  # soldier moves not countering the check
        try:
            self.assertFalse(non_counter_check_move)
        except:
            self.fail(
